...
module.exports = utils.inherit(Object, {
  ...
  setBinOwner: function (params, fn) {
    var sql = templates.setBinOwner,
        values = [params.name, params.url, params.revision, new Date(), params.summary, params.html?1:0, params.css?1:0, params.javascript?1:0, params.visibility || 'public'];
  ...
  archiveBin: function (bin, fn) {
    var values = [bin.archive?1:0, bin.name, bin.url, bin.revision],
  ...
  updateOwners: function (params, fn) {
    // params.date is only for use when populating the summary field
    var values = [params.date || new Date(), params.summary, params.panel_open?1:0, params.name, params.url, params.revision]; //jshint ignore:line
