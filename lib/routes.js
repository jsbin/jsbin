...
module.exports = function (app) {
  ...
  app.get('/account/upgrade', features.route('upgrade'), upgradeHandler.payment);
  app.post('/account/upgrade', features.route('upgrade'), upgradeHandler.processPayment);
  app.get('/account/upgrade/features', features.route('upgrade'), upgradeHandler.features);
