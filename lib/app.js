var nodemailer = require('nodemailer'),
    ...
    generateSessionSecret = function () {
      console.log('Warning: Generating a session key - please see http://github.com/jsbin/jsbin/blob/master/docs/session-keys.md');
      var sessionSecretChars = [];
      for (var i = 0; i < 34; i++) {
        sessionSecretChars[i] = Math.floor(Math.random() * 36).toString(36);
      }
      var secret = sessionSecretChars.join('');
      return secret;
    };
