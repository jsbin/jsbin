...
module.exports = function (app) {
  ...
  // Save as template
  app.get('/save-as-template', binParamFromReferer, binHandler.loadBin, userHandler.saveTemplateURL);
  app.post('/save-as-template', function (req, res, next) {
    reBin.lastIndex = 0; // reset position
    ...
    next();
  }, binHandler.loadBin, userHandler.saveTemplateURL);
