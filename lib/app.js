...
app.post('/logout', session.logoutUser);

// List
app.get('/list', handlers.getUserBins);
...
// Save
app.post('/save', handlers.validateBin, handlers.createBin);
app.post('/:bin/:rev?/save', handlers.validateBin, handlers.createRevision);
