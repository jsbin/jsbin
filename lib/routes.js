...
module.exports = function (app) {
  ...
  // header
  app.get('/:bin/output-header',
    function (req, res) {
      res.render('output-header', {
        code_id_path: req.bin.url,
      });
    }
  );

  app.get('/:bin/:rev?/output-header',
    function (req, res) {
      res.render('output-header', {
        code_id_path: req.bin.url,
      });
  ...
  app.get('/:bin/:rev?/:quiet(quiet)',
    binHandler.testQuietAccess,
    spike.getStream,
...
>>>>>>> Wrapping full preview in iframe to protect XSS
