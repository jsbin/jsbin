...
app.get('/:bin/:rev?/:quiet(quiet)?', spike.getStream, handlers.getBinPreview);
...
if (require.main === module) {
  store.connect(function (err) {
    ...
    module.exports.listen(process.env.PORT || 3000);
    console.log('JS Bin running on port ' + (process.env.PORT || 3000));
  });
}
