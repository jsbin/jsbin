...
upgrade.features = function (req, res, next) {
  ...
  res.render('features', {
    ...
    description: 'JS Bin Pro Accounts: Pro accounts keep JS Bin 100% free for education, and give you private bins, vanity urls, asset uploading and supports JS Bin\'s continued operation'
  });
};
