...
module.exports = function (app) {
  ...
  function secureOutput(req, res, next) {
    ...
    console.log(req.secure, features('sslForAll', req));
  ...
  app.get('/', secureOutput, binHandler.getDefault);
  ...
  app.get('/bin/user.js', function (req, res, next) {
