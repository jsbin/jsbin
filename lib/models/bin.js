...
var model = {
  ...
  fileFromBin: function (bin) {
    ...
    function createOutputObj(memo, panelName) {
      ...
      memo[panelName] = prePro && processors[prePro] ? processors[prePro](content) : content;
      return memo;
    }
    ...
    // return html;
    var createFileFromBin = require('../dropbox/createFileFromBin');
    var binObject = binPanels.reduce(createOutputObj, {});
    binObject.raw = {
      html: bin.html,
      css: bin.css,
      js: bin.javascript
    };
    binObject.processors = binPrePro;
