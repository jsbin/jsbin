var nodemailer = require('nodemailer'),
    ...
    MemcachedStore = require('memcached-express')(express),
...
// expose memcache for testing
replify('memcache', sessionStore);
...
app.connect = function (callback) {
  ...
  app.configure(function () {
    ...
    app.use(express.cookieParser('superfabulousecret'/*app.set('session secret')*/));
    app.use(function(req,res, next){
      console.log(req.signedCookies);
      console.log(req.signedCookies.jsbin);
      if (!req.signedCookies.jsbin || req.signedCookies.jsbin.constructor === String) {
        // new way
        express.session({
          key: 'jsbin',
          cookie: {
