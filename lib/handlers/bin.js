...
>>>>>>> Removing iframe from new rendered output, in favour of inline header
...
>>>>>>> Removing iframe from new rendered output, in favour of inline header
    ...
    // - remove preview-header code and hogan support
    helpers.render('preview-header', { code_id_path: helpers.urlForBin(bin) }, function (err, header) {
      var re = null,
