...
module.exports = function (app) {
  ...
  app.post('/login', sessionHandler.checkUserLoggedIn, userHandler.validate, sessionHandler.loginUser );
  app.post('/signup', sessionHandler.checkUserLoggedIn, userHandler.validateRegister, sessionHandler.loginUser); 
