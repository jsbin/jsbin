...
Libraries.prototype.init = function () {
  var libs = {
    ...
    jqueryui : {
      text: 'jQuery UI',
      requires: 'http://ajax.googleapis.com/ajax/libs/jquery/1.4.2/jquery.min.js',
      style: 'http://ajax.googleapis.com/ajax/libs/jqueryui/1.8.0/themes/base/jquery-ui.css',
      scripts: [
