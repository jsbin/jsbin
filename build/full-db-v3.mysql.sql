...
CREATE TABLE `sandbox` (
  ...
  `streaming_key` char(32) COLLATE utf8mb4_unicode_ci,
  `streaming_read_key` char(32) COLLATE utf8mb4_unicode_ci,
  `active_tab` varchar(10) COLLATE utf8mb4_unicode_ci,
  `active_cursor` int(11),
  `revision` int(11) DEFAULT '1',
