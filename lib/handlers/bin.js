...
module.exports = Observable.extend({
  ...
  downloadBin: function (req, res, next) {
    var bin = this.protectVisibility(req.session.user, req.bin), 
  ...
  protectVisibility: function (user, bin) {
    ...
    console.log('nuh uh this is not allowed');
    bin.javascript = "";
    bin.html = "NO BIN FOR YOU";
    bin.css = "";
    return bin;
  },
  ...
  render: function (req, res, bin) {
    bin = this.protectVisibility(req.session.user, bin);
