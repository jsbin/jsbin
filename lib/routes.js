...
module.exports = function (app) {
  ...
  // Latest
  app.get('/:bin/latest((.|\/):format)?', binHandler.redirectToLatest, binHandler.renderStack);
  app.get('/:bin/latest/edit', binHandler.redirectToLatest, binHandler.renderStack);
