...
module.exports = Observable.extend({
  ...
  createBin: function (req, res, next) {
    console.log('BinHandler#createBin');
  ...
  claimBin: function (req, res, next) {
    console.log('BinHandler#claimBin');
  ...
  completeCreateBin: function (bin, req, res, next, renderFn) {
    ...
    function render() {
      if (renderFn) { // AKA API route
        renderFn();
      } else { // AKA from the browser
