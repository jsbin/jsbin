...
module.exports = function (app) {
  ...
  app.post('/save', binHandler.createBin, binHandler.ensureBin, binHandler.renderCreated);

  // This is called when I save in a named url (jsbin.com/mybin)
  app.post('/:bin/:rev?/save', binHandler.ensureBin, binHandler.createRevisionOrClone, binHandler.renderCreated);
