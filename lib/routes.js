...
module.exports = function (app) {
  ...
  app.post('/login', features.route('sslLogin'), sessionHandler.checkUserLoggedIn, userHandler.validateLogin, sessionHandler.loginUser);

  // TODO /register should take them through to logged in if the details are correct
  app.post('/register', features.route('sslLogin'), sessionHandler.checkUserLoggedIn, userHandler.validateRegister, sessionHandler.loginUser);
