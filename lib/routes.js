...
module.exports = function (app) {
  ...
  app.get('/upgrade', features.route('stripe'), function (req, res) {

    var featureList = JSON.stringify(require('./data/features.json').list);
    var backersList = JSON.stringify(require('./data/backers.json').backers);
    ...
    var stripeKey = config.payment.stripe.public;
