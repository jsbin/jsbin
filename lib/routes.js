...
module.exports = function (app) {
  ...
  // "latest" url action.
  app.param('bin', binHandler.loadBin, binHandler.checkPrivate);
  ...
  // TODO: Need to add an authentication handler - also handle user not logged in
  app.get('/pro', sessionHandler.setProAccount);
