...
module.exports = function (app) {
  ...
  function renderLoginRegister(req, res) {
    ...
    if (req.query.firsttime) {
      res.flash(req.flash.NOTIFICATION, 'We\'ve <a target="_blank" href="/blog/ssl">upgraded our login process to use SSL</a>, however, this does mean  you have been logged out today, so please could you log in again.<br><br><a href="http://github.com/jsbin/jsbin/issues/new" target="_blank">Questions/problems?</a>');
    }
