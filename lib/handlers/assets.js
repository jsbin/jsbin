...
module.exports = function assets (sandbox) {
  var models = sandbox.models;
  var assetHandler = {};
  assetHandler.sign = function (req, res) {
  ...
  assetHandler.remove = function (req, res) {
  ...
  assetHandler.size = function (req, res) {
  ...
  if (!AWS_ACCESS_KEY || !AWS_SECRET_KEY || !S3_BUCKET) {
    ...
    Object.keys(assetHandler).forEach(function (prop) {
      if (prop !== 'name') {
        assets[prop] = noop;
      }
    });
