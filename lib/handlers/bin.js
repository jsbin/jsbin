...
module.exports = Observable.extend({
  ...
  createBinOrRevision: function (req, res, next) {
    // Horribly ambiguous url that can be used to create a new bin with a
    // provided bin url or update an existing one with no revision.
    // We use :url instead of :bin to prevent 404ing on a bin to be created.
  ...
  notFound: function (req, res) {
    ...
    this.renderFiles(req, res, files, req.param('bin'));
  },
