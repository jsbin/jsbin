...
module.exports = Observable.extend({
  constructor: function BinHandler() {
    ...
    Object.getOwnPropertyNames(BinHandler.prototype).forEach(function (prop) {
  ...
  render: function (req, res, bin) {
    var template = this.templateFromBin(bin),
        jsbin = this.jsbin(bin, req.helpers.production ? req.helpers.set('version') : 'debug', req.session._csrf),
        _this = this;
