...
// Edit
app.get('/:bin/edit', handlers.getBin);
app.get('/:bin/:rev/edit', handlers.getBin);

// Source
app.get('/:bin.:format(js|css|html)', handlers.getBinSource);
app.get('/:bin/:rev.:format(js|css|html)', handlers.getBinSource);
app.get('/:bin/:format(js)', handlers.getBinSource);
app.get('/:bin/:rev/:format(js)', handlers.getBinSource);
