...
module.exports = utils.inherit(Object, {
  ...
  setBinUser: function (params, fn) {
    var sql = templates.setBinForUser,
        values = [params.name, params.url, params.revision, new Date(), params.summary];
  ...
  touchOwnership: function (params, fn) {
    ...
    var values = [params.date || new Date(), params.summary, params.name, params.url, params.revision];
