...
module.exports = utils.inherit(Object, {
  ...
  setBinPanel: function (panel, params, fn) {
    var values = [ params[panel], params.settings, new Date(), params.url, params.revision, params.streamingKey ],
  ...
  applyBinDefaults: function (bin) {
    ...
    if (!bin.last_updated || isNaN(bin.last_updated.getTime())) {
      bin.last_updated = new Date('2012-07-23 00:00:00');
    }
