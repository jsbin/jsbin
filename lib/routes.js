...
module.exports = function (app) {
  ...
  app.get('/account/assets/sign', features.route('assets'), middleware.cors(), assetHandler.sign);

  app.get('/account/assets/sign', features.route('!assets'), middleware.cors(), function (req, res, next) {
    res.statusCode = 403;
    res.send('This feature isn\'t publically available yet');
  });
